...
const { data } = await getSitePage('privacy');
...
<template>
  <div class="bg-w2-500 p-4 md:p-8 lg:p-12">
    ...
    <TabView :active-index="1" @tab-change="onTabChange">
      <TabPanel :header="$t('info.company')" />
      <TabPanel :header="$t('info.privacy_policy')" contentStyle="padding: 2.5rem 15px 30px">
